      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">
            Privacy-preserving bounties, judged by AI.
          </h2>
          <p className="mt-2 max-w-2xl text-sm text-zinc-400">
            Commit a hashed answer, reveal it after the deadline, then let Ritual AI rank all
          ...
          <div className="mt-3 flex flex-wrap gap-2 text-xs text-zinc-400">
            <span className="rounded-full bg-white/5 px-3 py-1 ring-1 ring-inset ring-white/10">
              Commit-reveal: answers stay hidden until the reveal phase.
            </span>
            <span className="rounded-full bg-white/5 px-3 py-1 ring-1 ring-inset ring-white/10">
